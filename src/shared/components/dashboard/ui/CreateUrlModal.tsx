...
export default function CreateUrlModal({ isOpen, onClose, onCreate }: URLShortenerModalProps) {
    ...
    return (
        <div
            ...
            className="fixed top-0 right-0 left-0 bottom-0  z-50 flex items-start justify-center backdrop-blur-md rounded-2xl">
            <form
                onSubmit={handleSubmit}
                className="text-neutral-800 py-6 relative top-30 overflow-hidden flex flex-col justify-around w-[450px] min-h-[280px] border border-purple-300 rounded-lg bg-neutral-50 p-6 shadow-xl">
                ...
                <div className="before:absolute before:w-32 before:h-20 before:right-2 before:bg-[#f05ee7] before:-z-10 before:rounded-full before:blur-xl before:-top-12 z-10 after:absolute after:w-24 after:h-24 after:bg-[#ba63d9] after:-z-10 after:rounded-full after:blur-lg after:-top-12 after:-right-6">
                    ...
                    <p className="text-neutral-700 text-sm mt-1">Enter your long URL and optionally customize your short link</p>
                </div>
