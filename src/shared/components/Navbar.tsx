            ...
            <aside
                ...
                <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-[#222949]">
                    <div className="flex items-center gap-3">
                        ...
                        <h2 className="text-lg font-bold text-transparent bg-clip-text bg-linear-to-r from-purple-400 to-purple-600">SlimLink</h2>
                    </div>
                    <button
                        onClick={closeDrawer}
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 border-t border-gray-200 dark:border-[#222949]">
                    <p className="text-sm text-gray-500 dark:text-gray-400 text-center">© 2025 SlimLink</p>
                </div>
            </aside>
        </>
    )
